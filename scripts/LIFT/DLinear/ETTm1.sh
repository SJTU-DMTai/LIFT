...
for pred_len in 24
do
  leader_num=1; state_num=4; learning_rate=0.001
...
for pred_len in 48
do
  leader_num=2; state_num=2; learning_rate=0.001
  python -u run_longExp.py \
    --dataset $data --model $model_name --lift --seq_len $seq_len --pred_len $pred_len \
    --itr $itr \
    --checkpoints "" \
...
for pred_len in 96
do
  leader_num=2; state_num=2; learning_rate=0.0005
  python -u run_longExp.py \
    --dataset $data --model $model_name --lift --seq_len $seq_len --pred_len $pred_len \
    --itr $itr \
    --checkpoints "" \
...
do
  leader_num=1; state_num=1; learning_rate=0.001
  python -u run_longExp.py \
    --dataset $data --model $model_name --lift --seq_len $seq_len --pred_len $pred_len \
    --itr $itr \
    --checkpoints "" \
